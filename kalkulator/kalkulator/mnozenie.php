    ...
    <section class="glowny">
        ...
        <script>
            ...
            if(l_zadan == 10|| l_zadan > 10){
                ...
                document.getElementById("dobre").innerHTML = "Test został zakończony" + "</br>" + "Twój wynik to: " + poprawne + "<br/>" + "<form action='mnozenie.php' method='post' name='formularz'>Imię: <input type='text' name='imie'> Nazwisko: <input type='text' name='nazwisko'> Klasa: <input name='klasa' type='text'><input type='hidden' name='punkty' id='punkty' readonly><input type='hidden' name='rodzaj_testu' value='mnozenie' readonly></br><button name='zapisz' id='zapisz'>Prześlij wynik</button></form>";
